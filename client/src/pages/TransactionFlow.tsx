  ...
  const validateAddressAndSearch = () => {
    address && address !== ""
      ...
      : Modal.error({
          ...
          content:
            "No address was entered, please enter a valid address and try again.",
        });
  };

  return (
    <div className="h-screen">
      <div className="flex flex-row content-center space-x-5 justify-start align-center h-[100px] bg-blue-500">
        {/* <img src={chainLensLogo} alt="" height={'100px'} width={'100px'} /> */}
